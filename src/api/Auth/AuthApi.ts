...
const AuthApi = {
  register: (params: IRegisterFieldType) => {
    return axiosCustomize.post<ICustomDesignedResponse,ICustomDesignedResponse>(`${apiUrl}/user/register`, params);
  },
  login: (params: ILoginFieldType) => {
    return axiosCustomize.post<ICustomDesignedResponse,ICustomDesignedResponse>(`${apiUrl}/auth/login`, params)
  },
  fetchAccount: () => {
    return axiosCustomize.get<ICustomDesignedResponse,ICustomDesignedResponse>(`${apiUrl}/auth/account`);
  }
};
